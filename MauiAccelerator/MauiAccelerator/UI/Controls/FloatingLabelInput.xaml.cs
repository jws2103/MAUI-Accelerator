...
{
    readonly int _placeholderFontSize = 18;
    readonly int _titleFontSize = 14;
    readonly int _topMargin = -32;
    ...
    public static readonly BindableProperty TitleProperty = BindableProperty.Create(nameof(Title), typeof(string), typeof(string), string.Empty, BindingMode.TwoWay, null);
    ...
    public static readonly BindableProperty IsPasswordProperty = BindableProperty.Create(nameof(IsPassword), typeof(bool), typeof(FloatingLabelInput), default(bool));
    public static readonly BindableProperty KeyboardProperty = BindableProperty.Create(nameof(Keyboard), typeof(Keyboard), typeof(FloatingLabelInput), Keyboard.Default, coerceValue: (o, v) => (Keyboard)v ?? Keyboard.Default);
